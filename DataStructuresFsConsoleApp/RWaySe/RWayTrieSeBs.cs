...
{
    public class RWayTrieSeBs<TKey, TValue> : IEnumerable<KeyValuePair<TKey, TValue>>
    {
        ...
        public RWayTrieSeBs(Stream stream, bool open)
            : this(stream, new BinaryFormatter(), new BinaryFormatter(), open)
        {
        }

        public RWayTrieSeBs(Stream stream, IFormatter keySerializer, IFormatter valueSerializer, bool open)
        {
            _stream = stream;
